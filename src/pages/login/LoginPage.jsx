    ...
    <>
      ...
      <div className="white-bg br-m p-xxl pt-xl pb-xl" style={{width: "30rem"}}>
        ...
        <div className="flex flex-column">
          ...
          <input type="text" name="email" className="p-xs txt-s lynx-white-color br-s mb-s " style={{border: "1px solid grey"}}
            placeholder="tanay@neog.camp"/>
        </div>
        <div className="flex flex-column">
          <label for="password">Password</label>
          <input type="password" name="password" className="p-xs txt-s lynx-white-color br-s flex items-center" style={{border: "1px solid grey"}}
            placeholder="************"/>
        </div>
        ...
        <a href="#" className="txt-center w-full mt-m" style={{display: "block"}}>Create New Account</a>
      </div>
    </div>
    </>
  )
